...
// Shared suspicious patterns for input validation
...
function containsSuspiciousPattern(input, patterns = SUSPICIOUS_PATTERNS) {
...
export function validateEmployeeName(input) {
  ...
  if (containsSuspiciousPattern(sanitized, SUSPICIOUS_PATTERNS.slice(0, 5))) {
